...
//
//   @override
//   void paint(pw.Context context, PdfRect box, [pw.PaintPhase phase = pw.PaintPhase.all]) {
...
//     );
//
//     context.canvas.lineTo(OX(horizontalMargin - coordinate.width), coordinate.height);
//
