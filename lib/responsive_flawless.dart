...
class ReceiptShapeBorder extends ShapeBorder {
  ...
  const ReceiptShapeBorder({required this.horizontalMargin});
  ...
  Path getOuterPath(ui.Rect rect, {ui.TextDirection? textDirection}) {
    ...
    final double remainedSpace = (width - 2 * cornerWidth) % peakWidth;
    cornerWidth += remainedSpace / 2;

    var numberOfPeaks = (width - 2 * cornerWidth) / peakWidth;
    ...
    print('WIDTH: $width ~ HEIGHT: ${rect.height}');
    print('START OY: $startingPointY | START OX: $startingPointX');
