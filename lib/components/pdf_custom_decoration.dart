...
class PdfCustomDecoration implements pdf.BoxDecoration{
  ...
  @override
  pdf.BoxBorder? get border => pdf.Border.all(
  ...
  @override
  void paint(pdf.Context context, PdfRect box, [pdf.PaintPhase phase = pdf.PaintPhase.all]) {
    ...
    context.canvas.lineTo(
        OX(horizontalMargin - coordinate.width),
        coordinate.height,
    );

    /// From top left to bottom left |
    // context.canvas.lineTo(coordinate.width,OY(box.height - 2.666665371 * peakHeight + topGap - coordinate.height));
